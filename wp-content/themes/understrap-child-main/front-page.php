                ...
                <div>
                    <section class="stnc-section">
                        <div class="stnc-container">
                            ...
                            <!-- LEFT SIDE -->
                            <div id="menu-for-the-week" class="stnc-column">
                                <h2 class="h4 md:h3 m-0! mb-4">
                                    MENU FOR THE <span class="text-primary">WEEK</span>
                                </h2>
								<?php
                            ...
                            <!-- RIGHT SIDE -->
                            <div id="latest-news" class="stnc-column">
                                <h2 class="h4 md:h3 m-0! mb-4">
...
<!-- NEW CUSTOM BOTH Section end -->
             ...
             <!-- Section start -->
            <div id="staff-resources" class="section panel overflow-hidden">
